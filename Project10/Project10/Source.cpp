...
int main(int argc, char **argv) {
	...
	while (1)
	{
		al_draw_text(font, al_map_rgb(0, 255, 255), 350, 300, ALLEGRO_ALIGN_CENTER, "Have a lonely Valentines Day!!!!");
		al_draw_text(font, al_map_rgb(0, 255, 255), 350, 100, ALLEGRO_ALIGN_CENTER, "Boiiii");
		t++;
		ALLEGRO_EVENT ev;
